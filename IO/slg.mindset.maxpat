...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.0, 169.0, 52.0, 48.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 19.0, 6.0, 129.0, 20.0 ],
					"text" : "MindSet OSC Server"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 114.0, 315.0, 105.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 19.0, 19.0, 105.0, 16.0 ],
					"text" : "sylvain.legroux@upf.edu"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 455.0, 411.0, 50.0, 18.0 ],
					"text" : "29344"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 255.0, 419.0, 174.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 160.0, 392.0, 50.0, 18.0 ],
					"text" : "129614"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 410.0, 357.0, 45.0, 20.0 ],
					"text" : "zl sum"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 288.5, 451.5, 121.0, 107.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 19.0, 141.0, 123.0, 59.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"setstyle" : 1,
					"size" : 7,
					"slidercolor" : [ 0.0, 0.568627, 0.831373, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.0, 314.0, 205.0, 34.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 19.0, 233.0, 205.0, 34.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 55.0, 217.0, 20.0, 20.0 ],
					"text" : "m"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 39.0, 217.0, 19.0, 20.0 ],
					"text" : "a"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"parameter_enable" : 0,
									"patching_rect" : [ 413.0, 199.0, 50.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 341.0, 199.0, 50.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "float" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 62.0, 276.0, 36.0, 15.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 70.0, 307.0, 152.0, 29.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 50.0, 307.0, 20.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 135.0, 100.0, 200.0, 41.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 125.0, 144.0, 200.0, 41.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 111.0, 188.0, 156.0, 52.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 96.0, 241.0, 159.0, 64.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 104.0, 100.0, 89.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 91.0, 144.0, 34.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 77.0, 188.0, 40.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 64.0, 241.0, 60.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 288.0, 277.0, 157.0, 18.0 ],
									"text" : "/mindset/raw $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 270.0, 255.0, 157.0, 18.0 ],
									"text" : "/mindset/meditation $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 256.0, 231.0, 157.0, 18.0 ],
									"text" : "/mindset/attention $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 74.0, 39.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 266.333313, 396.0, 25.0, 25.0 ]
								}
...
,
					"patching_rect" : [ 13.0, 258.0, 73.0, 20.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 180.0, 341.0, 67.0, 18.0 ],
									"text" : "972800"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 180.0, 308.0, 46.0, 20.0 ],
									"text" : "peak"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 100.0, 341.0, 67.0, 18.0 ],
									"text" : "2019132"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 29.0, 341.0, 67.0, 18.0 ],
									"text" : "3704959"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "int", "int", "int" ],
									"patching_rect" : [ 29.0, 308.0, 46.0, 20.0 ],
									"text" : "peak"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 200.0, 125.0, 69.0, 18.0 ],
									"text" : "Low-Gamma"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 180.0, 148.0, 59.0, 18.0 ],
									"text" : "High-Beta"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 173.0, 170.0, 59.0, 18.0 ],
									"text" : "Low-Beta"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 161.0, 193.0, 59.0, 18.0 ],
									"text" : "High-Alpha"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 148.0, 215.0, 60.0, 18.0 ],
									"text" : "Low-Alpha"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 128.0, 239.0, 36.0, 18.0 ],
									"text" : "Theta"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 114.0, 262.0, 32.0, 18.0 ],
									"text" : "Delta"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 150.0, 125.0, 51.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 133.0, 148.0, 48.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 117.0, 170.0, 57.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 100.0, 193.0, 61.996094, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 83.0, 215.0, 66.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 67.0, 239.0, 62.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 50.0, 261.0, 64.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 365.0, 240.0, 157.0, 18.0 ],
									"text" : "/mindset/highgamma $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 346.0, 220.0, 157.0, 18.0 ],
									"text" : "/mindset/highbeta $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 333.0, 198.0, 157.0, 18.0 ],
									"text" : "/mindset/lowbeta $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 320.0, 175.0, 157.0, 18.0 ],
									"text" : "/mindset/highalpha $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 304.0, 154.0, 157.0, 18.0 ],
									"text" : "/mindset/lowalpha $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 293.0, 134.0, 157.0, 18.0 ],
									"text" : "/mindset/theta $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 280.0, 114.0, 157.0, 18.0 ],
									"text" : "/mindset/delta $1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 315.142883, 341.0, 25.0, 25.0 ]
								}
...
,
					"patching_rect" : [ 90.0, 258.0, 64.0, 20.0 ],
					"saved_object_attributes" : 					{
						"tags" : "",
						"default_fontface" : 0,
						"digest" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 118.0, 511.0, 36.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 105.0, 68.0, 36.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_unitstyle" : 0,
							"parameter_type" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 548.0, 247.0, 100.0, 20.0 ],
					"text" : "prepend port"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 692.0, 202.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 20.0, 212.0, 11.0, 11.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 548.0, 222.0, 100.0, 20.0 ],
					"text" : "route text"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 549.0, 176.0, 184.0, 18.0 ],
					"text" : "set /dev/tty.MindSet-DevB-1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 549.0, 201.0, 138.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 42.5, 212.0, 138.0, 17.0 ],
					"prototypename" : "M4L.display",
					"rounded" : 0.0,
					"text" : "/dev/tty.MindSet-DevB-3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 734.0, 257.0, 181.0, 20.0 ],
					"text" : "vexpr $f1 / $f2 @scalarmode 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 734.0, 284.0, 164.0, 92.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"setstyle" : 1,
					"settype" : 0,
					"size" : 7
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 553.0, 285.0, 164.0, 92.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 19.0, 93.0, 123.0, 41.0 ],
					"setminmax" : [ -1000.0, 1000000.0 ],
					"setstyle" : 3,
					"settype" : 0,
					"size" : 7
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 141.0, 45.0, 47.0, 95.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 204.0, 56.0, 59.0, 144.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_unitstyle" : 0,
							"parameter_mmax" : 100.0,
							"parameter_type" : 0,
							"parameter_shortname" : "Attention",
...
, 			{
				"box" : 				{
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"frgb" : [ 0.0, 0.568627, 0.831373, 1.0 ],
					"id" : "obj-74",
					"maxclass" : "comment",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 682.0, 8.0, 151.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 19.0, 44.0, 71.0, 20.0 ],
					"text" : "Start/Stop:",
					"textcolor" : [ 0.0, 0.568627, 0.831373, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 551.0, 120.0, 100.0, 20.0 ],
					"text" : "select 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 552.0, 94.0, 14.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 126.0, 44.0, 15.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "off", "on" ],
							"parameter_mmax" : 1.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 541.0, 13.0, 100.0, 20.0 ],
					"saved_object_attributes" : 					{
						"overdrive" : 0,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 19.0, 67.0, 51.0, 20.0 ],
					"text" : "Signal:",
					"textcolor" : [ 0.0, 0.568627, 0.831373, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 194.0, 42.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 194.0, 74.0, 83.0, 18.0 ],
					"text" : "alpha 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 89.0, 44.0, 47.0, 95.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 149.0, 56.0, 55.0, 144.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_unitstyle" : 0,
							"parameter_mmax" : 100.0,
							"parameter_type" : 0,
							"parameter_shortname" : "Meditation",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 542.0, 64.0, 100.0, 20.0 ],
					"text" : "delay 500"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 541.0, 39.0, 100.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 344.0, 65.0, 178.0, 30.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 177.0, 6.0, 58.0, 44.0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-101" : [ "live.button", "live.button", 0 ],
			"obj-117" : [ "live.numbox[10]", "live.numbox", 0 ],
			"obj-75" : [ "live.slider[1]", "Attention", 0 ],
			"obj-67" : [ "live.toggle", "live.toggle", 0 ],
			"obj-48" : [ "live.slider", "Meditation", 0 ],
			"obj-136::obj-53" : [ "live.numbox[2]", "live.numbox", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "slg.sendosc.maxpat",
				"bootpath" : "/Applications/Max5/slg.patches/IO",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
