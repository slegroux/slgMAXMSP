...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 112.0, 255.0, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 209.0, 75.0, 62.0, 20.0 ],
					"text" : "select 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 230.5, 296.0, 233.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 209.0, 326.0, 242.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 401.0, 161.0, 234.0, 18.0 ],
					"text" : "window size 100 100 350 350, window exec"
				}
...
,
					"patching_rect" : [ 31.0, 87.5, 122.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 112.0, 326.0, 77.0, 18.0 ],
					"text" : "topmost 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 401.0, 191.0, 292.0, 32.0 ],
					"text" : "window flags grow, window flags zoom, window title, window front, window exec"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 395.0, 122.0, 533.0, 18.0 ],
					"text" : "window flags nogrow, window flags nozoom, window notitle, window back, window exec"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 31.0, 43.5, 122.0, 21.5 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 213.199997, 375.0, 25.0, 25.0 ]
				}
