{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 1.0, 44.0, 460.0, 202.0 ],
		"bglocked" : 0,
		"defrect" : [ 1.0, 44.0, 460.0, 202.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 513.0, 412.0, 223.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 25.0, 621.0, 223.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 376.0, 365.0, 89.0, 18.0 ],
					"text" : "deletepersonal"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 373.0, 392.0, 86.0, 18.0 ],
					"text" : "showpersonal"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 458.0, 112.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 135.0, 328.0, 52.0, 18.0 ],
					"text" : "dispose"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 21.0, 278.0, 100.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 90.0, 83.0, 18.0 ],
					"text" : "s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 140.0, 90.0, 69.0, 18.0 ],
					"text" : "yo"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 1 ],
					"hidden" : 0,
					"midpoints" : [ 143.5, 194.0, 44.0, 194.0 ],
					"source" : [ "obj-46", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 3 ],
					"hidden" : 0,
					"midpoints" : [ 357.0, 119.0, 274.0, 119.0, 274.0, 228.0, 71.0, 228.0 ],
					"source" : [ "obj-54", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 4 ],
					"hidden" : 0,
					"midpoints" : [ 347.0, 242.0, 84.5, 242.0 ],
					"source" : [ "obj-68", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 6 ],
					"hidden" : 0,
					"midpoints" : [ 542.5, 261.0, 111.5, 261.0 ],
					"source" : [ "obj-71", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 5 ],
					"hidden" : 0,
					"midpoints" : [ 425.5, 253.0, 98.0, 253.0 ],
					"source" : [ "obj-75", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 2 ],
					"hidden" : 0,
					"midpoints" : [ 258.5, 214.0, 57.5, 214.0 ],
					"source" : [ "obj-9", 0 ]
				}
