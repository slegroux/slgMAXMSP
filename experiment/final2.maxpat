{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 399.0, 50.0, 219.0, 340.0 ],
		"bglocked" : 0,
		"defrect" : [ 399.0, 50.0, 219.0, 340.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 702.0, 313.0, 69.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 387.0, 241.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 29.0, 280.0, 22.0, 20.0 ],
					"text" : "5)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 310.0, 241.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 29.0, 210.0, 22.0, 20.0 ],
					"text" : "4)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 277.0, 241.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 28.0, 160.0, 22.0, 20.0 ],
					"text" : "3)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 243.0, 237.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 28.0, 110.0, 22.0, 20.0 ],
					"text" : "2)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 185.0, 236.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 29.0, 59.0, 22.0, 20.0 ],
					"text" : "1)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 700.0, 248.0, 53.0, 20.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 700.0, 226.0, 97.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 49.0, 200.0, 130.0, 40.0 ],
					"text" : "Instructions"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 290.0, 89.0, 53.0, 20.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 290.0, 64.0, 120.0, 18.0 ],
					"text" : "load soundstimulus2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 150.0, 64.0, 119.0, 18.0 ],
					"text" : "load demographics2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 58.0, 101.0, 18.0 ],
					"text" : "load soundcheck"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 170.0, 190.0, 153.0, 18.0 ],
					"text" : "exec \"drop table  ratings\""
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 50.0, 50.0, 130.0, 40.0 ],
					"text" : "Agreement"
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 1.0, 44.0, 592.0, 306.0 ],
						"bglocked" : 0,
						"defrect" : [ 1.0, 44.0, 592.0, 306.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 1,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 470.0, 250.0, 100.0, 20.0 ],
									"text" : "No, thanks. Quit"
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 360.0, 250.0, 100.0, 20.0 ],
									"text" : "Yes, I accept"
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 20.0, 10.0, 349.0, 24.0 ],
									"text" : "Agreement:"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 20.0, 60.0, 600.0, 160.0 ],
									"presentation" : 1,
									"presentation_linecount" : 10,
									"presentation_rect" : [ 20.0, 50.0, 552.0, 177.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 29.0, 260.0, 171.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 29.0, 40.0, 171.0, 210.0 ],
					"prototypename" : "M4L.border",
					"rounded" : 16
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 67.0, 10.0, 90.0, 23.0 ],
					"text" : "Experiment"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 49.0, 270.0, 130.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 49.0, 150.0, 130.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 49.0, 100.0, 130.0, 40.0 ],
					"text" : "Sound Level",
					"tosymbol" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 450.0, 190.0, 79.0, 18.0 ],
					"text" : "deleteratings"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 190.0, 76.0, 18.0 ],
					"text" : "createtables"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 19.0, 246.0, 67.0, 20.0 ],
					"text" : "r database"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 351.0, 189.0, 89.0, 18.0 ],
					"text" : "deletepersonal"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 449.0, 212.0, 76.0, 18.0 ],
					"text" : "showratings"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 350.0, 210.0, 86.0, 18.0 ],
					"text" : "showpersonal"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 170.0, 212.0, 155.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 105.0, 193.0, 53.0, 18.0 ],
					"text" : "closedb"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "list", "", "", "" ],
					"patching_rect" : [ 19.0, 305.0, 631.0, 225.0 ],
					"rows" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 34.0, 215.0, 106.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 19.0, 279.0, 112.0, 20.0 ],
					"text" : "js experimentDB.js"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 150.0, 88.0, 53.0, 20.0 ],
					"text" : "pcontrol"
				}
