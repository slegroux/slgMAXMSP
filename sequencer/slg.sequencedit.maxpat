{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 463.0, 227.0, 847.0, 581.0 ],
		"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
		"bglocked" : 0,
		"defrect" : [ 463.0, 227.0, 847.0, 581.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 410.0, 240.0, 197.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 5.0, 60.0, 140.0, 20.0 ],
					"readonly" : 1,
					"rounded" : 1.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 50.0, 15.0, 45.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.501961, 0.541176, 0.603922, 1.0 ],
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "int" ],
					"patching_rect" : [ 205.0, 85.0, 47.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 50.0, 35.0, 40.0, 20.0 ],
					"rounded" : 0.0,
					"text" : "Save"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "int" ],
					"patching_rect" : [ 205.0, 60.0, 47.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 100.0, 35.0, 45.0, 20.0 ],
					"rounded" : 0.0,
					"text" : "Editor"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "int" ],
					"patching_rect" : [ 205.0, 40.0, 47.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 35.0, 40.0, 20.0 ],
					"rounded" : 0.0,
					"text" : "Open"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 385.0, 25.0, 253.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 435.0, 85.0, 75.0, 20.0 ],
					"text" : "pvar pattern"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 347.0, 51.0, 229.0, 20.0 ],
					"text" : "OSC-route /selection /pattern /track /read"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 590.0, 50.0, 59.5, 20.0 ],
					"restore" : 					{
						"pattern" : [ 5 ],
						"sel-princ" : [ 2 ]
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 55.0, 85.0, 75.0, 20.0 ],
					"text" : "pvar pattern"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 264.0, 11.0, 20.0, 20.0 ],
					"text" : "lb"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 163.0, 13.0, 72.0, 20.0 ],
					"text" : "loadmess 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 5.0, 40.0, 100.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 52.0, 133.0, 59.5, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 105.0, 15.0, 42.0, 18.0 ],
					"text" : "read"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 0.0, 15.0, 42.0, 18.0 ],
					"text" : "open"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 409.0, 200.0, 111.5, 200.0 ],
					"source" : [ "obj-11", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 356.5, 116.0, 228.0, 116.0, 228.0, 36.0 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 514.5, 136.0, 203.0, 136.0, 203.0, 109.0, 61.5, 109.0 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-26", 2 ],
					"hidden" : 0,
					"midpoints" : [ 179.5, 191.0, 111.5, 191.0 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 14.5, 170.0, 78.5, 170.0 ],
					"source" : [ "obj-62", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-39", 0 ],
					"hidden" : 0,
					"midpoints" : [ 114.5, 123.0, 61.5, 123.0 ],
					"source" : [ "obj-41", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-39", 0 ],
					"hidden" : 0,
					"midpoints" : [ 9.5, 130.0, 61.5, 130.0 ],
					"source" : [ "obj-80", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-26", 2 ],
					"hidden" : 0,
					"midpoints" : [ 61.5, 186.0, 111.5, 186.0 ],
					"source" : [ "obj-39", 0 ]
				}
