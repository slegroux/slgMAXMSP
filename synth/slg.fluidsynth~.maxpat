{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 354.0, 82.0, 818.0, 594.0 ],
		"bglocked" : 0,
		"defrect" : [ 354.0, 82.0, 818.0, 594.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 436.0, 356.0, 63.0, 20.0 ],
					"text" : "s #0-ctl"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 144.0, 367.0, 61.0, 20.0 ],
					"text" : "r #0-ctl"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 702.0, 308.0, 103.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 702.0, 272.0, 56.0, 20.0 ],
					"text" : "pack 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 702.0, 232.0, 43.0, 20.0 ],
					"text" : "pgmin"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 606.0, 311.0, 87.0, 15.0 ],
					"text" : "control $2 $1 $3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 606.0, 287.0, 58.0, 17.0 ],
					"text" : "pack 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 606.0, 235.0, 58.0, 17.0 ],
					"text" : "ctlin"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 521.0, 310.0, 67.0, 17.0 ],
					"text" : "prepend bend"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 521.0, 287.0, 58.0, 17.0 ],
					"text" : "pack 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 521.0, 235.0, 58.0, 17.0 ],
					"text" : "bendin"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 436.0, 310.0, 67.0, 17.0 ],
					"text" : "prepend note"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 436.0, 287.0, 58.0, 17.0 ],
					"text" : "pack 0 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "int", "int" ],
					"patching_rect" : [ 436.0, 235.0, 58.0, 17.0 ],
					"text" : "notein"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 430.0, 113.0, 42.0, 20.0 ],
					"text" : "pak i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 430.0, 139.0, 89.0, 18.0 ],
					"text" : "program $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 289.0, 456.0, 104.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 342.0, 553.0, 75.0, 18.0 ],
					"text" : "prepend note"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 342.0, 530.0, 61.0, 18.0 ],
					"text" : "pack 0 0 1"
				}
...
,
					"patching_rect" : [ 214.0, 117.0, 44.0, 20.0 ],
...
,
					"patching_rect" : [ 59.0, 147.0, 42.0, 19.0 ],
					"saved_object_attributes" : 					{
						"fontname" : "Verdana",
						"default_fontsize" : 10.0,
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 159.0, 121.0, 51.0, 19.0 ],
					"saved_object_attributes" : 					{
						"fontname" : "Verdana",
						"default_fontsize" : 10.0,
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 103.0, 121.0, 52.0, 19.0 ],
					"saved_object_attributes" : 					{
						"fontname" : "Verdana",
						"default_fontsize" : 10.0,
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 173.0, 55.0, 35.0, 17.0 ],
					"text" : "/info"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 129.0, 55.0, 35.0, 17.0 ],
					"text" : "/info"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 90.0, 54.0, 34.0, 17.0 ],
					"text" : "/load"
				}
...
,
					"patching_rect" : [ 47.0, 121.0, 37.0, 19.0 ],
					"saved_object_attributes" : 					{
						"fontname" : "Verdana",
						"default_fontsize" : 10.0,
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 209.0, 491.0, 54.0, 19.0 ],
					"text" : "print info"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 97.0, 465.0, 63.0, 19.0 ],
					"text" : "route bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 97.0, 491.0, 18.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 268.0, 120.0, 17.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 267.0, 143.0, 51.0, 17.0 ],
					"text" : "mute $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 47.0, 425.0, 66.0, 19.0 ],
					"text" : "fluidsynth~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 114.0, 492.0, 85.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 12,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 47.0, 79.0, 467.0, 19.0 ],
					"text" : "OSC-route /info /chorus /reverb /load /mute /pitch /velocity /duration /channel /pc /direct"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 47.0, 55.0, 23.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 72.0, 488.0, 23.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 47.0, 488.0, 23.0, 23.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-48", 0 ],
					"hidden" : 0,
					"midpoints" : [ 351.5, 584.0, 270.0, 584.0, 270.0, 394.0, 56.5, 404.0 ],
					"source" : [ "obj-75", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 260.136353, 386.0, 298.5, 386.0 ],
					"source" : [ "obj-56", 5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 300.863647, 389.0, 341.0, 389.0 ],
					"source" : [ "obj-56", 6 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 341.590912, 383.0, 383.5, 383.0 ],
					"source" : [ "obj-56", 7 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 382.318176, 431.0, 393.5, 431.0 ],
					"source" : [ "obj-56", 8 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 382.318176, 107.0, 462.5, 107.0 ],
					"source" : [ "obj-56", 8 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 423.045441, 102.0, 439.5, 102.0 ],
					"source" : [ "obj-56", 9 ]
				}
